...
profile_images_folder = os.path.join(current_dir, '../../data/profile_images_19988')
...
def get_cell_content_endpoint():
    ...
    # notebook_path = f'../../competition_19988_filter/{notebook_title}'
    notebook_path = os.path.join(current_dir, f'../../competition_19988_filter/{notebook_title}')
