...
# Define the paths
image_save_directory = r'F:\Desktop\PHD\RAG_project\RAG_project5\profile_images2'
...
unique_usernames_df = pd.read_csv('F:/Desktop/PHD/RAG_project/RAG_project5/not_downloaded_usernames.csv')
